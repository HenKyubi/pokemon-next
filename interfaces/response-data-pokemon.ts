// To parse this data:
//
//   import { Convert, ResponseDataPokemon } from "./file";
//
//   const responseDataPokemon = Convert.toResponseDataPokemon(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ResponseDataPokemon {
  data: Data;
  status: number;
  statusText: string;
  headers: ResponseDataPokemonHeaders;
  config: Config;
  request: Request;
}
...
export interface ResponseDataPokemonHeaders {
...
export class Convert {
  public static toResponseDataPokemon(json: string): ResponseDataPokemon {
    return cast(JSON.parse(json), r("ResponseDataPokemon"));
  }

  public static responseDataPokemonToJson(value: ResponseDataPokemon): string {
    return JSON.stringify(uncast(value, r("ResponseDataPokemon")), null, 2);
  }
}
...
const typeMap: any = {
  ResponseDataPokemon: o(
    [
      { json: "data", js: "data", typ: r("Data") },
      { json: "status", js: "status", typ: 0 },
      { json: "statusText", js: "statusText", typ: "" },
      { json: "headers", js: "headers", typ: r("ResponseDataPokemonHeaders") },
