// To parse this data:
//
//   import { Convert, ResponseAllPokemons } from "./file";
//
//   const responseAllPokemons = Convert.toResponseAllPokemons(json);
//
...
export interface ResponseAllPokemons {
  ...
  status: number;
  statusText: string;
  headers: ResponseAllPokemonsHeaders;
  config: Config;
  request: Request;
}
...
export interface ResponseAllPokemonsHeaders {
...
export class Convert {
  public static toResponseAllPokemons(json: string): ResponseAllPokemons {
    return cast(JSON.parse(json), r("ResponseAllPokemons"));
  }

  public static responseAllPokemonsToJson(value: ResponseAllPokemons): string {
    return JSON.stringify(uncast(value, r("ResponseAllPokemons")), null, 2);
  }
}
...
const typeMap: any = {
  ResponseAllPokemons: o(
    [
      { json: "data", js: "data", typ: r("Data") },
      { json: "status", js: "status", typ: 0 },
      { json: "statusText", js: "statusText", typ: "" },
      { json: "headers", js: "headers", typ: r("ResponseAllPokemonsHeaders") },
