// To parse this data:
//
//   import { Convert, ResponseSpeciesPokemon } from "./file";
//
//   const responseSpeciesPokemon = Convert.toResponseSpeciesPokemon(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ResponseSpeciesPokemon {
  data: Data;
  status: number;
  statusText: string;
  headers: ResponseSpeciesPokemonHeaders;
  config: Config;
  request: Request;
}
...
export interface ResponseSpeciesPokemonHeaders {
...
export class Convert {
  public static toResponseSpeciesPokemon(json: string): ResponseSpeciesPokemon {
    return cast(JSON.parse(json), r("ResponseSpeciesPokemon"));
  }

  public static responseSpeciesPokemonToJson(
    value: ResponseSpeciesPokemon
  ): string {
    return JSON.stringify(uncast(value, r("ResponseSpeciesPokemon")), null, 2);
  }
}
...
const typeMap: any = {
  ResponseSpeciesPokemon: o(
    [
      ...
      { json: "statusText", js: "statusText", typ: "" },
      {
        json: "headers",
        js: "headers",
        typ: r("ResponseSpeciesPokemonHeaders"),
      },
  ...
  ResponseSpeciesPokemonHeaders: o(
    [
