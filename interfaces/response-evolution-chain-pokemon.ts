// To parse this data:
//
//   import { Convert, ResponseEvolutionChainPokemon } from "./file";
//
//   const responseEvolutionChainPokemon = Convert.toResponseEvolutionChainPokemon(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ResponseEvolutionChainPokemon {
  data: Data;
  status: number;
  statusText: string;
  headers: ResponseEvolutionChainPokemonHeaders;
  config: Config;
  request: Request;
}
...
export interface ResponseEvolutionChainPokemonHeaders {
...
export class Convert {
  public static toResponseEvolutionChainPokemon(
    json: string
  ): ResponseEvolutionChainPokemon {
    return cast(JSON.parse(json), r("ResponseEvolutionChainPokemon"));
  }

  public static responseEvolutionChainPokemonToJson(
    value: ResponseEvolutionChainPokemon
  ): string {
    return JSON.stringify(
      uncast(value, r("ResponseEvolutionChainPokemon")),
      null,
      2
    );
  }
...
const typeMap: any = {
  ResponseEvolutionChainPokemon: o(
    [
      ...
      { json: "statusText", js: "statusText", typ: "" },
      {
        json: "headers",
        js: "headers",
        typ: r("ResponseEvolutionChainPokemonHeaders"),
      },
    ...
    [
      {
        ...
        js: "evolution_details",
        typ: a(r("EvolutionDetail")),
      },
  ...
  EvolutionDetail: o(
    [
      ...
      {
        json: "relative_physical_stats",
        js: "relative_physical_stats",
        typ: null,
      },
  ...
  ResponseEvolutionChainPokemonHeaders: o(
    [
