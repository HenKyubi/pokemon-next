// To parse this data:
//
//   import { Convert, ResponseByColor } from "./file";
//
//   const responseByColor = Convert.toResponseByColor(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ResponseByColor {
  data: Data;
  status: number;
  statusText: string;
  headers: ResponseByColorHeaders;
  config: Config;
  request: Request;
}
...
export interface ResponseByColorHeaders {
...
export class Convert {
  public static toResponseByColor(json: string): ResponseByColor {
    return cast(JSON.parse(json), r("ResponseByColor"));
  }

  public static responseByColorToJson(value: ResponseByColor): string {
    return JSON.stringify(uncast(value, r("ResponseByColor")), null, 2);
  }
}
...
const typeMap: any = {
  ResponseByColor: o(
    [
      ...
      { json: "headers", js: "headers", typ: r("ResponseByColorHeaders") },
  ...
  Name: o(
    [
      { json: "language", js: "language", typ: r("PokemonSpecy") },
      { json: "name", js: "name", typ: "" },
    ],
    false
  ),
