// To parse this data:
//
//   import { Convert, PokemonData } from "./file";
//
//   const pokemonData = Convert.toPokemonData(json);
//
...
export class Convert {
  public static toPokemonData(json: string): PokemonData {
    return cast(JSON.parse(json), r("PokemonData"));
  }

  public static pokemonDataToJson(value: PokemonData): string {
    return JSON.stringify(uncast(value, r("PokemonData")), null, 2);
  }
}
