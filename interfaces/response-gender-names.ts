// To parse this data:
//
//   import { Convert, ResponseGenderNames } from "./file";
//
//   const responseGenderNames = Convert.toResponseGenderNames(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ResponseGenderNames {
  data: Data;
  status: number;
  statusText: string;
  headers: ResponseGenderNamesHeaders;
  config: Config;
  request: Request;
}
...
export interface ResponseGenderNamesHeaders {
...
export class Convert {
  public static toResponseGenderNames(json: string): ResponseGenderNames {
    return cast(JSON.parse(json), r("ResponseGenderNames"));
  }

  public static responseGenderNamesToJson(value: ResponseGenderNames): string {
    return JSON.stringify(uncast(value, r("ResponseGenderNames")), null, 2);
  }
}
...
const typeMap: any = {
  ResponseGenderNames: o(
    [
      { json: "data", js: "data", typ: r("Data") },
      { json: "status", js: "status", typ: 0 },
      { json: "statusText", js: "statusText", typ: "" },
      { json: "headers", js: "headers", typ: r("ResponseGenderNamesHeaders") },
