// To parse this data:
//
//   import { Convert, ResponseTypesNames } from "./file";
//
//   const responseTypesNames = Convert.toResponseTypesNames(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ResponseTypesNames {
  data: Data;
  status: number;
  statusText: string;
  headers: ResponseTypesNamesHeaders;
  config: Config;
  request: Request;
}
...
export interface ResponseTypesNamesHeaders {
...
export class Convert {
  public static toResponseTypesNames(json: string): ResponseTypesNames {
    return cast(JSON.parse(json), r("ResponseTypesNames"));
  }

  public static responseTypesNamesToJson(value: ResponseTypesNames): string {
    return JSON.stringify(uncast(value, r("ResponseTypesNames")), null, 2);
  }
}
...
const typeMap: any = {
  ResponseTypesNames: o(
    [
      { json: "data", js: "data", typ: r("Data") },
      { json: "status", js: "status", typ: 0 },
      { json: "statusText", js: "statusText", typ: "" },
      { json: "headers", js: "headers", typ: r("ResponseTypesNamesHeaders") },
